...
import { FormGroup, FormBuilder, Validators, AbstractControl, AsyncValidatorFn, AsyncValidator }
  from '@angular/forms';
...
export class CountryEditComponent implements OnInit {
  ...
  // the city ibject id, as fetched from the active route:
  ...
  loadData() {
    ...
    if (this.id) {
      ...
      this.http.get<Country>(url).subscribe(result => {
        ...
        // update the form eith the country value
